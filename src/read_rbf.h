...
void read_fixed_bitwise(Output output, std::istream &stream, size_t count,
                        const size_t size, F &&fread_word) {
...
template <typename Output, typename F>
void read_fixed_byte(Output output, std::istream &stream, size_t count,
                     const size_t size, F &&read_value) {
  while (count != 0) {
...
void read_bin_rbf(Output output, std::istream &stream, size_t count,
                  size_t size) {
  detail::read_fixed_bitwise(output, stream, count, size, &fread_BIN);
}
template <typename Output>
void read_pck_rbf(Output output, std::istream &stream, size_t count,
                  size_t size) {
  detail::read_fixed_bitwise(output, stream, count, size, &fread_PCK);
}
template <typename Output>
void read_chr_rbf(Output output, std::istream &stream, size_t count,
                  size_t size) {
  detail::read_fixed_byte(
      output, stream, count, size,
      std::bind(&fread_fixed_string, std::placeholders::_1, size));
}
template <typename Output>
void read_int_rbf(Output output, std::istream &stream, size_t count) {
  detail::read_fixed_byte(output, stream, count, sizeof(uint16_t),
                          &fread_uint16_t);
}
template <typename Output>
void read_long_rbf(Output output, std::istream &stream, size_t count) {
  detail::read_fixed_byte(output, stream, count, sizeof(uint32_t),
                          &fread_uint32_t);
}
template <typename Output>
